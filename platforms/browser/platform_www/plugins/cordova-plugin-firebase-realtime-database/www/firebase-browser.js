cordova.define("cordova-plugin-firebase-realtime-database.FirebaseDatabasePlugin", function(require, exports, module) { exports.getInstanceId = function(success, error) {
    success();
};
